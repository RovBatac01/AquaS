...
class _CalendarPageState extends State<CalendarPage> {
  ...
  final EventApiService _eventApiService = EventApiService(); // Initialize the API service
  ...
  void _startMidnightTimer() {
    ...
    _midnightTimer = Timer(durationUntilMidnight, () {
      ...
      _fetchEventsForSelectedDay(_selectedDay); // Re-fetch events for the new day
          ...
          children: [
            TableCalendar(
              ...
              onDaySelected: (selectedDay, focusedDay) {
                ...
                _fetchEventsForSelectedDay(selectedDay); // Fetch events for the newly selected day
              },
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        TextFormField(
                                          ...
                                          maxLines: null, // Allows multi-line input if needed
                                  ...
                                  actions: [
                                    ...
                                    ElevatedButton(
                                      onPressed: () async { // Make it async
                                        ...
                                        if (title.isNotEmpty) { // Only title is strictly required by backend
                                          try {
                                            final newEvent = Event(
                                              title: title,
                                              time: time.isNotEmpty ? time : null, // Pass null if empty
                                              description: desc.isNotEmpty ? desc : null, // Pass null if empty
                                              eventDate: date,
                                            );
                                            await _eventApiService.addEvent(newEvent);
                                            Navigator.of(context).pop();
                                            _fetchEventsForSelectedDay(date); // Re-fetch events after adding
                                          } catch (e) {
                                          ...
                                          ScaffoldMessenger.of(context).showSnackBar(
                                            SnackBar(content: Text('Schedule title cannot be empty.')),
                                          );
                                        }
                                      },
                                ...
                                onPressed: () async {
                                  if (event.id != null) {
                                    try {
                                      ...
                                      _fetchEventsForSelectedDay(_selectedDay); // Re-fetch events after deleting
                                    } catch (e) {
