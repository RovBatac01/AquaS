...
class _SAdminDetailsState extends State<SAdminDetails> {
  ...
  void _updateCircularIndicatorValues() {
    ...
    const double maxTemp = 100.0; // Example: Max expected temperature in Celsius
    const double maxTDS = 100.0; // Example: Max expected TDS in PPM
    const double maxPH = 14.0; // Max pH scale
    const double maxTurbidity = 100.0; // Max turbidity percentage (0-100%)
    const double maxConductivity = 100.0; // Example: Max expected conductivity in mS/cm
    const double maxSalinity = 100.0; // Example: Max expected salinity in ppt
    const double maxECCompensated = 100.0; // Example: Max expected compensated EC in mS/cm
